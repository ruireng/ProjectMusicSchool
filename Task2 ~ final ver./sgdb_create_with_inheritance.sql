...
ALTER TABLE person ADD CONSTRAINT FK_person_0 FOREIGN KEY (address_id) REFERENCES address (address_id) ON DELETE RESTRICT;
...
ALTER TABLE student_contact_person ADD CONSTRAINT FK_student_contact_person_0 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
ALTER TABLE student_contact_person ADD CONSTRAINT FK_student_contact_person_1 FOREIGN KEY (contact_person_id) REFERENCES contact_person (person_id) ON DELETE RESTRICT;


ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_0 FOREIGN KEY (instructor_id) REFERENCES instructor (person_id) ON DELETE RESTRICT;
...
ALTER TABLE gro ADD CONSTRAINT FK_group_0 FOREIGN KEY (instructor_id) REFERENCES instructor (person_id) ON DELETE RESTRICT;
...
ALTER TABLE individual ADD CONSTRAINT FK_individual_2 FOREIGN KEY (instructor_id) REFERENCES instructor (person_id) ON DELETE RESTRICT;
ALTER TABLE individual ADD CONSTRAINT FK_individual_3 FOREIGN KEY (room_id) REFERENCES room (room_id) ON DELETE RESTRICT;
ALTER TABLE individual ADD CONSTRAINT FK_individual_4 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
...
ALTER TABLE instructor_instrument_type ADD CONSTRAINT FK_instructor_instrument_type_0 FOREIGN KEY (instructor_id) REFERENCES instructor (person_id) ON DELETE RESTRICT;
...
ALTER TABLE instrument ADD CONSTRAINT FK_instrument_3 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
...
ALTER TABLE rental_records ADD CONSTRAINT FK_rental_records_1 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;


ALTER TABLE sibling_to ADD CONSTRAINT FK_sibling_to_0 FOREIGN KEY (sibling_student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
ALTER TABLE sibling_to ADD CONSTRAINT FK_sibling_to_1 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;


ALTER TABLE students_of_ensemble ADD CONSTRAINT FK_students_of_ensemble_0 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
...
ALTER TABLE students_of_group ADD CONSTRAINT FK_students_of_group_0 FOREIGN KEY (student_id) REFERENCES student (person_id) ON DELETE RESTRICT;
