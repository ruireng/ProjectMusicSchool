...
INSERT INTO sibling_to (student_id)
VALUES
  (6),
  (26),
  (16),
...
INSERT INTO pricing (lesson_type_id,price_of_beginner,price_of_intermediate,price_of_advanced,sibling_discount,instructor_pay_percentage)
VALUES
  (2,26,29,139,0.70,0.600),
  (2,80,53,200,0.80,0.650),
  (3,19,151,240,0.80,0.700);

INSERT INTO instructor (address_id,phone_number,first_name,last_name,mail_address,ssn)
VALUES
  (4,'541464256927688','Althea','Farrell','feugiat@protonmail.couk','599832164573'),
  (26,'651163467432136','Doris','Christensen','donec.felis.orci@google.ca','197344628292'),
  (21,'641252787318762','Cade','Joyner','vel.est@yahoo.ca','898582163377'),
  (49,'212752396542425','Fritz','Long','rutrum@outlook.net','653642146485'),
  (44,'819256765176542','Lillian','Owen','non.egestas@google.net','724438268648'),
  (14,'281553644868256','Dominic','Graves','pellentesque.tellus@google.edu','987145525458'),
  (28,'673586662762283','Silas','Rivers','proin.nisl.sem@icloud.edu','528575545265'),
  (20,'616577162847263','Baker','Suarez','aliquam@outlook.net','353189695562'),
  (12,'215338171378285','Donna','Sparks','nunc.pulvinar@outlook.com','643763782756'),
  (15,'726466212785333','Stephanie','Petersen','mauris.sagittis@outlook.net','751176624888');
...
VALUES
  (7,2,5,6,3,'2005-11-24 14:00:01','2005-11-24 13:14:59',9,6),
  (8,2,2,9,2,'2005-11-24 16:48:11','2005-11-24 14:08:46',1,6),
  (4,1,2,11,2,'2005-11-24 08:29:44','2005-11-24 13:11:37',2,0),
  (10,2,4,4,2,'2005-11-24 09:48:19','2005-11-24 15:50:26',2,5),
  (5,1,2,4,3,'2005-11-24 16:55:36','2005-11-24 10:33:19',6,6),
  (9,2,4,5,2,'2005-11-24 11:50:29','2005-11-24 15:29:47',4,4),
  (2,3,4,18,2,'2005-11-24 08:57:28','2005-11-24 13:42:21',3,10);

INSERT INTO group_lesson (instructor_id,skill_level_id,instrument_type_id,room_id,pricing_id,start_time,end_time,max_no_of_students,min_no_of_students)
VALUES
  (7,2,3,20,1,'2005-11-24 11:10:08','2005-11-24 12:16:43',9,2),
  (5,1,5,8,3,'2005-11-24 12:18:21','2005-11-24 15:41:50',4,0),
  (3,3,6,14,2,'2005-11-24 14:56:54','2005-11-24 12:13:56',9,3),
  (3,2,6,17,2,'2005-11-24 13:34:53','2005-11-24 10:00:23',3,10),
  (5,3,7,2,3,'2005-11-24 15:55:48','2005-11-24 08:41:17',2,4),
  (4,3,2,1,1,'2005-11-24 11:20:31','2005-11-24 16:43:49',7,6);

INSERT INTO individual_lesson (instructor_id,skill_level_id,instrument_type_id,room_id,pricing_id,student_id,start_time,end_time)
VALUES
  (1,2,5,8,2,20,'2005-11-24 11:37:00','2005-11-24 17:15:55'),
  (2,1,6,7,2,7,'2005-11-24 12:08:34','2005-11-24 09:24:43'),
  (1,3,10,9,1,16,'2005-11-24 13:25:25','2005-11-24 08:12:35'),
  (10,1,7,17,3,14,'2005-11-24 14:52:16','2005-11-24 18:41:23'),
  (9,2,9,13,2,21,'2005-11-24 18:01:10','2005-11-24 15:25:39'),
  (10,2,4,8,2,29,'2005-11-24 10:08:57','2005-11-24 12:48:29'),
  (10,2,7,17,2,8,'2005-11-24 18:00:07','2005-11-24 18:47:07'),
  (1,2,7,3,1,22,'2005-11-24 13:29:35','2005-11-24 15:47:26'),
  (1,2,9,1,2,17,'2005-11-24 09:50:04','2005-11-24 15:38:48'),
  (2,3,6,9,1,10,'2005-11-24 13:18:11','2005-11-24 14:05:35');
...
VALUES
  (7,2,27,4,'Jan 28, 2022','Nov 26, 2021'),
  (6,4,19,4,'Jan 19, 2023','Mar 14, 2022'),
  (10,10,3,25,'Feb 8, 2022','Jun 16, 2023'),
  (4,8,1,30,'Sep 16, 2022','Aug 31, 2023'),
  (5,2,6,4,'Dec 24, 2021','Sep 16, 2023'),
  (9,9,11,30,'Nov 29, 2021','May 31, 2022'),
  (10,4,14,16,'Sep 10, 2022','Apr 2, 2022'),
  (9,3,16,6,'May 9, 2022','Aug 21, 2023'),
  (9,10,28,11,'Jun 8, 2022','May 24, 2023'),
  (1,6,4,1,'Sep 7, 2022','Jun 26, 2022');
INSERT INTO instrument (brand_id,instrument_type_id,renting_id,student_id,start_date,return_date)
VALUES
  (3,2,22,21,'Mar 18, 2023','Jun 18, 2023'),
  (5,2,9,20,'Oct 16, 2023','Jan 14, 2023'),
  (10,9,21,8,'Jan 23, 2022','Nov 11, 2023'),
  (7,10,17,25,'Mar 17, 2023','Mar 14, 2022'),
  (10,6,22,18,'Mar 7, 2022','Jun 6, 2022'),
  (1,6,7,9,'Dec 19, 2021','Oct 1, 2023'),
  (9,4,10,12,'Aug 26, 2023','Jan 4, 2023'),
  (5,2,10,10,'Apr 18, 2022','Dec 23, 2022'),
  (3,4,25,26,'Feb 17, 2022','Jan 24, 2022'),
  (6,1,22,11,'Jun 28, 2023','Apr 23, 2023');
INSERT INTO instrument (brand_id,instrument_type_id,renting_id,student_id,start_date,return_date)
VALUES
  (6,8,29,21,'Dec 12, 2021','Feb 17, 2022'),
  (1,4,16,16,'Mar 26, 2023','Dec 12, 2021'),
  (1,1,6,27,'Nov 22, 2023','Nov 12, 2023'),
  (5,8,6,9,'Mar 31, 2022','Jul 26, 2023'),
  (3,9,3,26,'Jan 16, 2023','Feb 7, 2023'),
  (8,7,3,12,'Dec 17, 2022','Apr 14, 2022'),
  (4,4,26,8,'Feb 16, 2022','Jul 21, 2023'),
  (3,9,8,10,'Sep 30, 2023','Jul 19, 2023'),
  (10,7,3,24,'Dec 29, 2021','Nov 16, 2023'),
  (4,2,13,6,'Jan 7, 2022','Feb 3, 2022');
INSERT INTO instrument (brand_id,instrument_type_id,renting_id,student_id,start_date,return_date)
VALUES
  (10,8,13,8,'Sep 18, 2022','Dec 30, 2021'),
  (9,2,7,4,'Oct 28, 2023','May 20, 2023'),
  (2,2,30,6,'Jul 2, 2022','Sep 11, 2022'),
  (7,4,26,6,'Mar 11, 2023','Jun 8, 2022'),
  (1,9,17,28,'Oct 16, 2022','Dec 11, 2021'),
  (3,2,13,14,'Jun 23, 2022','Jun 5, 2022'),
  (1,1,10,28,'May 23, 2022','Dec 18, 2021'),
  (6,8,23,5,'Mar 25, 2023','Feb 2, 2022'),
  (9,6,17,19,'Jun 9, 2022','Aug 2, 2022'),
  (1,9,15,14,'Jan 4, 2022','Mar 3, 2022');
INSERT INTO instrument (brand_id,instrument_type_id,renting_id,student_id,start_date,return_date)
VALUES
  (10,9,1,27,'Jul 6, 2022','May 9, 2022'),
  (5,7,21,4,'Feb 24, 2022','Oct 29, 2023'),
  (6,7,12,15,'Apr 19, 2023','Oct 7, 2023'),
  (3,5,18,25,'Jul 13, 2023','Dec 22, 2022'),
  (2,5,26,7,'Jun 20, 2023','Mar 5, 2022'),
  (9,7,14,6,'Jul 17, 2023','Jan 13, 2023'),
  (8,10,18,28,'Sep 23, 2022','Sep 14, 2023'),
  (9,7,12,19,'Jun 7, 2022','Oct 29, 2023'),
  (7,6,9,19,'Dec 2, 2021','Apr 6, 2022'),
  (9,6,19,22,'Nov 24, 2022','Oct 16, 2023');

INSERT INTO rental_records (instrument_id,student_id,start_date,returned_date)
VALUES
  (8,13,'Dec 5, 2022','Mar 18, 2022'),
  (3,16,'Jan 27, 2023','Apr 27, 2022'),
  (4,29,'Jun 3, 2022','May 18, 2023'),
  (5,1,'Jan 29, 2022','Jul 9, 2023'),
  (10,26,'Oct 15, 2023','Sep 30, 2023');
